...
paths=(["bookinfo"]="Istio/samples/bookinfo/platform/kube/bookinfo-4.yaml" ["hotelreservation"]="DeathStarBench/hotelReservation/kubernetes" ["onlineboutique"]="OnlineBoutique/release/kubernetes-manifests.yaml")
